 ...
 <body>
   <div class="center_ct">
     <div class ="center" >
       ...
       <form style="margin-top:10px" action="choosedoctor.php" method="post">
       ...
       <input style="margin-top:5px" onclick="location.href='session_end.php';" type="button" value="Cancel" class =" btn btn-danger"/></p>
