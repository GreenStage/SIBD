<?php
  session_start();
    if(isset($_GET['doctor_id'])){
        ...
        $_SESSION['doctor_name'] = $_GET['doctor_name'];
    }
?>
<html>
  <head>
       ...
       <div class="form-group">
         ...
         <button  style="float:left" type="submit" value="Submit"  class ="btn btn-primary">
           ...
           Submit
            ...
            <input style="margin-left:5px" onclick="location.href='session_end.php';" type="button" value="Cancel" class =" btn btn-danger"/></p>
     </div>
   </div>
 </body>
 <script>
